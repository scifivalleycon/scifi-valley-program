const CACHE="sfvc-program-v4-79";
const LOCAL=[
  ...
  "./assets/icons/app-icon-maskable-512.png","./assets/icons/apple-touch-icon.png","./assets/icons/back-button.png","./assets/cosplay-clinic.png"
];
